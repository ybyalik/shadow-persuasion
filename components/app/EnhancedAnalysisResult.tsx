        ...
        <div className="flex-1">
            <div className="mb-3">
                <div className="flex justify-between items-center mb-1">
                    ...
                    <span className="text-lg font-bold text-white bg-[#333333] px-3 py-1 rounded">{value}/10</span>
                </div>
                {description && (
    ...
    return (
        <div className="grid grid-cols-1 xl:grid-cols-4 gap-6">
            ...
            <div className="xl:col-span-1">
                <div className="bg-[#1A1A1A] p-4 rounded-lg border border-[#333333] sticky top-0">
            ...
            <div className="xl:col-span-3 space-y-6">
                ...
                <div className="bg-[#1A1A1A] p-6 rounded-lg border border-[#333333]">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="bg-[#0A0A0A] p-4 rounded-md">
                            <p className="text-sm text-gray-300">{analysis.powerDynamics.dynamicsDescription}</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-[#1A1A1A] p-6 rounded-lg border border-[#333333]">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div className="text-center bg-[#0A0A0A] p-4 rounded-lg">
                        ...
                        <div className="text-center bg-[#0A0A0A] p-4 rounded-lg">
                            ...
                            <div className="text-xs text-gray-400">Their emotional state right now</div>
                        </div>
                ...
                <div className="bg-[#1A1A1A] p-6 rounded-lg border border-[#333333]">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                        {analysis.responseOptions.map((option, index) => (
                            <div
                                key={index}
                                className={`bg-[#222222] p-4 rounded-lg border transition-all cursor-pointer ${
                            ...
                            >
                                ...
                                <div className="bg-[#333333] p-3 rounded relative group">
                                    <p className="text-white font-medium text-sm pr-8">{option.message}</p>
                                    <button
                                        onClick={(e) => {
                                            e.stopPropagation();
                                            handleCopy(option.message);
                                        }}
                                        className="absolute top-2 right-2 p-1 bg-[#444444] rounded opacity-0 group-hover:opacity-100 transition-opacity hover:bg-[#555555]"
                                    >
                                    ...
                                    <div className="mt-3 pt-3 border-t border-[#333333] space-y-2">
                                        <div className="flex items-start gap-2">
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <p className="text-xs text-gray-300">{option.psychologyPrinciple}</p>
                                            </div>
                                        </div>
                                        
                                        <div className="bg-[#0A0A0A] p-2 rounded text-xs text-gray-400">
                ...
                <div className="bg-[#1A1A1A] p-6 rounded-lg border border-[#333333]">
                    ...
                    <div className="space-y-4">
                        <div className="prose prose-invert prose-sm max-w-none">
                            <p className="text-gray-300 leading-relaxed">{analysis.overallAnalysis}</p>
                        </div>
