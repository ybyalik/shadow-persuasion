...
export function ConversationCard({ conversation, onUpdate, onDelete }: ConversationCardProps) {
    ...
    return (
        <div className="bg-[#1A1A1A] border border-[#333333] rounded-lg p-6 space-y-4 hover:border-[#444444] transition-colors">
            {/* Header */}
            <div className="flex items-start justify-between">
                <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                        <h3 className="font-bold text-lg text-white">{conversation.personName}</h3>
                    ...
                    <p className="text-sm text-gray-400">{conversation.context}</p>
                ...
                <div className="relative">
                    ...
                    {showDropdown && (
                        <div className="absolute right-0 top-8 bg-[#222222] border border-[#333333] rounded-lg shadow-lg z-10 min-w-[120px]">
                            <button
                                onClick={() => {
                            ...
                            <button
                                ...
                                className="w-full px-3 py-2 text-left text-sm hover:bg-[#333333] text-red-400 flex items-center gap-2"
                            >
            ...
            <div className="grid grid-cols-3 gap-3">
                <div className="text-center">
                    ...
                    <div className="text-xs text-gray-400 font-mono uppercase">{conversation.communicationStyle.sensoryPreference}</div>
                </div>
                ...
                <div className="text-center">
                    ...
                    <div className="text-xs text-gray-400 font-mono uppercase">Receptivity</div>
                </div>
                ...
                <div className="text-center">
                    ...
                    <div className="text-xs text-gray-400 font-mono uppercase">Techniques</div>
                </div>
            </div>
            ...
            <div className="bg-[#0A0A0A] p-3 rounded border-l-4 border-[#D4A017]">
                <div className="flex items-start gap-2">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-300">{conversation.nextRecommendedAction}</p>
                    </div>
                </div>
            </div>
            ...
            {isExpanded && (
                <div className="space-y-4 pt-4 border-t border-[#333333]">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-300">{conversation.communicationStyle.emotionalPattern}</p>
                    </div>
                        ...
                        <div>
                            ...
                            <div className="space-y-2">
                                {conversation.techniques.slice(0, 3).map((technique, index) => (
                                    <div key={index} className="flex items-center justify-between bg-[#222222] p-2 rounded">
                                        ...
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className="text-xs text-gray-400">{technique.effectiveness}%</span>
                                        </div>
                                    </div>
                                ))}
                    ...
                    {conversation.notes && (
                        <div>
                            ...
                            <p className="text-sm text-gray-300">{conversation.notes}</p>
                        </div>
                    )}
                    ...
                    {/* Metadata */}
                    <div className="text-xs text-gray-500 pt-2 border-t border-[#333333] flex items-center gap-2">
