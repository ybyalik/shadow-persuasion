  ...
  return (
    <section className="border-4 border-black p-8 md:p-12 relative">
      ...
      <div className="text-center mb-8">
        <p className="text-5xl font-bold">$34.95/month</p>
        <p className="text-sm">That&apos;s about $1.17/day for an AI communication coach available 24/7</p>
      </div>
      <div className="max-w-md mx-auto">
        ...
        <a href="/login" className="block w-full text-center bg-black text-white py-4 px-8 text-xl font-bold hover:bg-gray-800 transition-colors duration-300">
          START TRAINING NOW
        </a>
      </div>
