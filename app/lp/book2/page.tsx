...
function BonusCard({
  ...
  // /app/admin/files keyed by these slugs).
    ...
    <main className={`${specialElite.className} bg-[#F4ECD8] text-[#1A1A1A] overflow-x-hidden`}>
      ...
      <section className="relative px-6 pt-12 pb-16 md:pt-20 md:pb-24">
        <div className="max-w-5xl mx-auto text-center">
          ...
          {/* Book mockup — admin-uploaded cover with CSS fallback */}
      ...
      <section className="px-6 py-16 bg-[#1A1A1A] text-[#F4ECD8]">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-lg md:text-xl text-center text-[#F4ECD8]/80 mb-10">
            This Shadow Persuasion model is unlike any method you&apos;ve heard of before. This is something{' '}<strong className="text-[#D4A017]">{' '}completely different</strong>, because...
          </p>
