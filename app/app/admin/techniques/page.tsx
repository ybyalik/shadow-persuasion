...
export default function TechniquesRedirectPage() {
    ...
    <div className="p-6 md:p-10">
      <div className="bg-[#111] border border-[#D4A017]/20 p-6 max-w-2xl">
        ...
        <p className="text-sm text-[#F4ECD8]/70 mb-4">
          Redirecting to the legacy admin page where dedup currently lives. Will be extracted to its own page in a follow-up.
        </p>
        <button
